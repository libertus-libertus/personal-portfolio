                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('experience.update', $experience->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="position" name="position" placeholder="Posisinya sebagai apa?" value="{{ $experience->position }}" autofocus>
                                    @error('position')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="company" name="company" placeholder="Nama perusahaan" value="{{ $experience->company }}">
                                    @error('company')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="employment_type" name="employment_type" placeholder="Misal: Dikantor/WFH (Work from home)" value="{{ $experience->employment_type }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="location" class="form-control" id="location" rows="3">{{ $experience->location }}</textarea>
                            @error('location')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="3">{{ $experience->description }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
