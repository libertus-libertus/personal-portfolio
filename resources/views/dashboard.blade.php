            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Keahlian (Skills)</p>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <p class="mb-0">
                                    Berikut portofolio projects saya
                                </p>
                            </div>
                        </div>
                        <div class="col-4 text-end">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Inbox (Email)</p>
                                <h5 class="font-weight-bolder">
                                    1,462
                                </h5>
                                <p class="mb-0">
                                    Pesan dari client melalui email
                                </p>
                            </div>
                        </div>
                        <div class="col-4 text-end">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Experiences</p>
                                <h5 class="font-weight-bolder">
                                    3 Perusahaan
                                </h5>
                                <p class="mb-0">
